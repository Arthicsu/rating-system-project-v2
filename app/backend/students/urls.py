...
urlpatterns: list = [
    ...
    path('api/v1/achievement/<int:pk>/', views.AchievementDetailAPIView.as_view(), name='api_achievement_detail'),
    ...
    path('api/v1/profile/', views.StudentProfileSelfAPIView.as_view(), name='api_student_profile_self'),
